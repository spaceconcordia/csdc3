...
GPIO_LOOKUP_TABLE = {
	...
	PSS_HR_MUX_SEL_GPIO: {DIR: OUTPUT, PIN: 'J4.26'},
...
TEMP_IDENTIFIER_DICT = {
    TEMP_PAYLOAD_A: {I2C: 0, MUX: 1, CH: 0, SUB: PAYLOAD, ADDR: 0x48},
    TEMP_PAYLOAD_B: {I2C: 0, MUX: 1, CH: 0, SUB: PAYLOAD, ADDR: 0x49},
    TEMP_PAYLOAD_BRD: {I2C: 0, MUX: 1, CH: 1, SUB: PAYLOAD, ADDR: 0x48},
    TEMP_PWR_BRD: {I2C: 0, MUX: 1, CH: 4, SUB: POWER, ADDR: 0x49},
    TEMP_BAT_1: {I2C: 0, MUX: 0, CH: 4, SUB: POWER, ADDR: 0x48},
    TEMP_BAT_2: {I2C: 0, MUX: 0, CH: 4, SUB: POWER, ADDR: 0x49},
    TEMP_BAT_3: {I2C: 0, MUX: 0, CH: 4, SUB: POWER, ADDR: 0x4a},
    TEMP_BAT_4: {I2C: 0, MUX: 0, CH: 4, SUB: POWER, ADDR: 0x4b},
    TEMP_EPS_BRD: {I2C: 0, MUX: 0, CH: 4, SUB: POWER, ADDR: 0x4c},
    TEMP_CDH_BRD: {I2C: 0, MUX: 0, CH: 4, SUB: CDH, ADDR: 0x4d}
}
