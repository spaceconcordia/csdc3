...
class PayloadHandler(tornado.web.RequestHandler):
    def get(self):
        ...
        for i in range(num_experiments):
            f.write(
r"""
                var chartstrain""" + str(i) + """ = new CanvasJS.Chart("chartPayloadStrain""" +  str(i) + """",
                {
                    animationEnabled: true,
                    title:{
                        text: " """ + str(i+1) + """. Strain VS. Time"
                    },
                    axisX:{
                        title: "time(sec)",
                        intervalType: "second",        
                    ...
                    data: [
                {
                    ...
                    showInLegend: true,
                    name: "series1",
                    legendText: "Payload Exp """ + str(i+1) + """ - Strain",
                    xValueType: "dateTime",
                    dataPoints: (payload_data['p""" + str(i) + """'])['strainConvList']
                }
                    ],
                legend: {
                    cursor: "pointer",
                    itemclick: function (e) {
                        ...
                        chartstrain""" + str(i) + """.render();
                    }
                }
                });
                chartstrain""" + str(i) + """.render();

                var chartload""" + str(i) + """ = new CanvasJS.Chart("chartPayloadLoad""" +  str(i) + """",
                {
                    animationEnabled: true,
                    title:{
                        text: " """ + str(i+1) + """. Load(N) VS. Time"
                    },
                    axisX:{
                        title: "time(sec)",
                        intervalType: "second",        
                    ...
                    data: [
                {
                    ...
                    showInLegend: true,
                    name: "series1",
                    legendText: "Payload Exp """ + str(i+1) + """ - Load",
                    xValueType: "dateTime",
                    dataPoints: (payload_data['p""" + str(i) + """'])['loadConvList']
                }
                    ],
                legend: {
                    cursor: "pointer",
                    itemclick: function (e) {
                        ...
                        chartload""" + str(i) + """.render();
                    }
                }
                });
                chartload""" + str(i) + """.render();

                var charttemp""" + str(i) + """ = new CanvasJS.Chart("chartPayloadTemp""" +  str(i) + """",
                {
                    animationEnabled: true,
                    title:{
                        text: " """ + str(i+1) + """. Temp VS. Time"
                    },
                    axisX:{
                        title: "time(sec)",
                        intervalType: "second",        
                    ...
                    data: [
                {
                    ...
                    showInLegend: true,
                    name: "series1",
                    legendText: "Payload Exp """ + str(i+1) + """ - Temperature",
                    xValueType: "dateTime",
                    dataPoints: (payload_data['p""" + str(i) + """'])['tempList']
                }
                    ],
                legend: {
                    cursor: "pointer",
...
"""
        ...
        f.write(
r"""
        <div class="main payload">
            <div class="row">
                <div class="col-xs-5"></div>
                <div class="col-xs-2">
                <div id="batterydata" class="dropdown">
